Analysis of the Online News Popularity lifestyle Channel
================
Landon Batts and Jose Singer-Freeman
due 2023-07-09

- <a href="#online-news-popularity-analysis-for-lifestyle-channel"
  id="toc-online-news-popularity-analysis-for-lifestyle-channel">Online
  News Popularity Analysis for lifestyle Channel</a>
...
# Online News Popularity Analysis for lifestyle Channel
...
lifestyle. You can find the analyses for the other channels in the
README file.
...
| 1188 | self_reference_max_shares  | self_reference_avg_sharess   |        0.99 |
| 1187 | self_reference_min_shares  | self_reference_avg_sharess   |        0.99 |
| 1134 | self_reference_min_shares  | self_reference_max_shares    |        0.97 |
| 702  | kw_max_min                 | kw_avg_min                   |        0.94 |
| 215  | n_unique_tokens            | n_non_stop_unique_tokens     |        0.93 |
| 108  | n_tokens_content           | n_unique_tokens              |       -0.86 |
| 161  | n_tokens_content           | n_non_stop_words             |        0.84 |
| 162  | n_unique_tokens            | n_non_stop_words             |       -0.82 |
| 2213 | global_rate_negative_words | rate_negative_words          |        0.81 |
| 2160 | global_rate_negative_words | rate_positive_words          |       -0.81 |
| 2699 | title_subjectivity         | abs_title_subjectivity       |       -0.79 |
| 2752 | title_subjectivity         | abs_title_sentiment_polarity |        0.78 |
| 2484 | avg_negative_polarity      | min_negative_polarity        |        0.76 |

``` r
    corrplot(corMat2, is.corr=FALSE, tl.col="black", na.label=" ") #plot  correlations absolute value above 0.5
```

![](images/lifestyle/correlation-1.png)<!-- -->
...
|:---------------------------|------------------------:|
| LDA_03                     |                   0.404 |
| global_rate_negative_words |                   0.267 |
| rate_negative_words        |                   0.256 |
| weekday_is_saturday        |                   0.157 |
| global_subjectivity        |                   0.156 |
| LDA_01                     |                   0.139 |
| abs_title_subjectivity     |                   0.129 |
| n_non_stop_unique_tokens   |                   0.129 |
| LDA_02                     |                   0.080 |
| weekday_is_wednesday       |                   0.077 |
| is_weekend                 |                   0.072 |
| n_unique_tokens            |                   0.059 |
| kw_min_max                 |                   0.056 |
| weekday_is_thursday        |                   0.031 |
| num_videos                 |                   0.030 |
| kw_min_avg                 |                   0.027 |
| average_token_length       |                   0.017 |
| max_negative_polarity      |                   0.003 |
| weekday_is_monday          |                  -0.011 |
| n_tokens_title             |                  -0.017 |
...
![](images/lifestyle/top3%20correlation%20plot-1.png)<!-- -->
...
![](images/lifestyle/weekday%20summary-1.png)<!-- -->
...
![](images/lifestyle/weekday%20summary-2.png)<!-- -->
...
![](images/lifestyle/plots%20and%20summaries-1.png)<!-- -->
...
```
    ...
    ## 1 720 1300 2000 3048.714 3296.436 3300 20800
...
![](images/lifestyle/unnamed-chunk-1-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 70, 68, 68, 69, 69, 69, ... 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared   MAE     
    ##   6740.153  0.1890107  4896.748
    ## 
...
| model               |     RMSE |
|:--------------------|---------:|
| Linear Regression 1 | 1883.078 |
| Linear Regression 2 | 2929.593 |
| Boosted Tree        | 3213.078 |
