Analysis of the Online News Popularity Entertainment Channel
================
Landon Batts and Jose Singer-Freeman
due 2023-07-09

- <a href="#online-news-popularity-analysis-for-entertainment-channel"
  id="toc-online-news-popularity-analysis-for-entertainment-channel">Online
  News Popularity Analysis for Entertainment Channel</a>
...
# Online News Popularity Analysis for Entertainment Channel
...
Entertainment. You can find the analyses for the other channels in the
README file.
...
| 702  | kw_max_min                 | kw_avg_min                   |        0.99 |
| 1188 | self_reference_max_shares  | self_reference_avg_sharess   |        0.94 |
| 215  | n_unique_tokens            | n_non_stop_unique_tokens     |        0.93 |
| 1835 | LDA_01                     | LDA_03                       |       -0.89 |
| 1620 | weekday_is_sunday          | is_weekend                   |        0.85 |
| 2160 | global_rate_negative_words | rate_positive_words          |       -0.85 |
| 2213 | global_rate_negative_words | rate_negative_words          |        0.85 |
| 2752 | title_subjectivity         | abs_title_sentiment_polarity |        0.83 |
| 2211 | global_sentiment_polarity  | rate_negative_words          |       -0.81 |
| 2158 | global_sentiment_polarity  | rate_positive_words          |        0.81 |
| 1026 | kw_max_avg                 | kw_avg_avg                   |        0.81 |
| 162  | n_unique_tokens            | n_non_stop_words             |       -0.79 |
...
![](images/entert/correlation-1.png)<!-- -->
...
|:-----------------------------|------------------------:|
| weekday_is_saturday          |                   0.370 |
| is_weekend                   |                   0.154 |
| global_subjectivity          |                   0.142 |
| min_positive_polarity        |                   0.141 |
| LDA_01                       |                   0.122 |
| avg_positive_polarity        |                   0.092 |
| self_reference_min_shares    |                   0.089 |
| weekday_is_thursday          |                   0.082 |
| n_non_stop_unique_tokens     |                   0.079 |
| global_rate_negative_words   |                   0.049 |
| n_tokens_title               |                   0.048 |
| max_positive_polarity        |                   0.047 |
| rate_negative_words          |                   0.046 |
| title_subjectivity           |                   0.041 |
| n_unique_tokens              |                   0.032 |
| global_sentiment_polarity    |                   0.027 |
| global_rate_positive_words   |                   0.024 |
| num_keywords                 |                   0.014 |
| weekday_is_monday            |                   0.008 |
| abs_title_sentiment_polarity |                   0.008 |
...
![](images/entert/top3%20correlation%20plot-1.png)<!-- -->
...
![](images/entert/weekday%20summary-1.png)<!-- -->
...
![](images/entert/weekday%20summary-2.png)<!-- -->
...
![](images/entert/plots%20and%20summaries-1.png)<!-- -->
...
```
    ...
    ## 1 379 957.5 1500 3029.127 4864.191 2500 35100
...
![](images/entert/unnamed-chunk-1-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 121, 119, 120, 122, 121, 119, ... 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared  MAE     
    ##   5938.261  0.10257   4072.537
    ## 
...
| model               |     RMSE |
|:--------------------|---------:|
| Linear Regression 1 | 2844.560 |
| Linear Regression 2 | 3951.164 |
| Boosted Tree        | 4934.057 |
