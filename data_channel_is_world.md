Analysis of the Online News Popularity World Channel
================
Landon Batts and Jose Singer-Freeman
due 2023-07-09

- <a href="#online-news-popularity-analysis-for-world-channel"
  id="toc-online-news-popularity-analysis-for-world-channel">Online News
  Popularity Analysis for World Channel</a>
...
# Online News Popularity Analysis for World Channel
...
social media, tech and world news. This is the analysis for the World.
You can find the analyses for the other channels in the README file.
...
| 1188 | self_reference_max_shares  | self_reference_avg_sharess   |        0.95 |
| 215  | n_unique_tokens            | n_non_stop_unique_tokens     |        0.93 |
| 1187 | self_reference_min_shares  | self_reference_avg_sharess   |        0.89 |
| 481  | n_non_stop_words           | average_token_length         |        0.87 |
| 967  | kw_max_min                 | kw_max_avg                   |        0.86 |
| 2214 | rate_positive_words        | rate_negative_words          |       -0.85 |
| 2213 | global_rate_negative_words | rate_negative_words          |        0.83 |
| 968  | kw_avg_min                 | kw_max_avg                   |        0.81 |
| 2752 | title_subjectivity         | abs_title_sentiment_polarity |        0.80 |
| 2158 | global_sentiment_polarity  | rate_positive_words          |        0.80 |
| 2211 | global_sentiment_polarity  | rate_negative_words          |       -0.77 |
| 2753 | title_sentiment_polarity   | abs_title_sentiment_polarity |        0.75 |
| 1026 | kw_max_avg                 | kw_avg_avg                   |        0.75 |

``` r
    corrplot(corMat2, is.corr=FALSE, tl.col="black", na.label=" ") #plot  correlations absolute value above 0.5
```

![](images/world/correlation-1.png)<!-- -->
...
| title_sentiment_polarity     |                   0.401 |
| num_imgs                     |                   0.344 |
| global_subjectivity          |                   0.244 |
| avg_positive_polarity        |                   0.240 |
| global_sentiment_polarity    |                   0.239 |
| title_subjectivity           |                   0.238 |
| LDA_00                       |                   0.133 |
| max_positive_polarity        |                   0.132 |
| num_hrefs                    |                   0.125 |
| num_keywords                 |                   0.121 |
| weekday_is_thursday          |                   0.110 |
| rate_positive_words          |                   0.102 |
| self_reference_max_shares    |                   0.097 |
| kw_avg_avg                   |                   0.087 |
| abs_title_subjectivity       |                   0.079 |
| min_positive_polarity        |                   0.065 |
| self_reference_avg_sharess   |                   0.061 |
| min_negative_polarity        |                   0.052 |
...
![](images/world/top3%20correlation%20plot-1.png)<!-- -->
...
![](images/world/weekday%20summary-1.png)<!-- -->
...
![](images/world/weekday%20summary-2.png)<!-- -->
...
![](images/world/plots%20and%20summaries-1.png)<!-- -->
...
```
    ...
    ## 1 492 915.75 1300 2544.383 5367.8 1925 53100
...
![](images/world/unnamed-chunk-1-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 109, 108, 108, 108, 107, 107, ... 
    ## Resampling results:
    ## 
    ##   RMSE        Rsquared   MAE      
    ##   2721714195  0.1369962  776144171
    ## 
...
| model               |     RMSE |
|:--------------------|---------:|
| Linear Regression 1 | 3989.860 |
| Linear Regression 2 | 5037.809 |
| Boosted Tree        | 5692.653 |
